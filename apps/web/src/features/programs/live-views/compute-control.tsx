...
export function ComputeControlLive() {
  ...
  const refresh = useCallback(async (signal?: AbortSignal) => {
    const result = await api.get<ComputeControlSnapshotResponse>("snapshot", signal ? { signal } : {});
