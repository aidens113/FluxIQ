...
export function getInstructionScopeRouter(api: ProgramCommandTransport, payload: Record<string, any>) { return api.post<{ router?: any }>("get-flow-router-summary", payload); }
