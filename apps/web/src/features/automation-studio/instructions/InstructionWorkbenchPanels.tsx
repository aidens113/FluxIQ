    ...
    <div className="automation-instruction-editor-sections">
      ...
      <section className="automation-instruction-editor-section automation-instruction-behavior-section">
        ...
        <div className="automation-instruction-behavior-grid">
          <div className="automation-instruction-scope-control"><label><span>Scope</span><select aria-label="Scope" value={draft.scopeKind} onChange={(event) => props.changeScope(event.target.value)}><option value="global">Global</option><option value="project">Project</option><option value="flow">Flow</option><option value="router">Router</option><option value="subflow">Subflow</option><option value="node">Node</option><option value="on_error">On Error</option><option value="adaptation_review">Adaptation Review</option></select></label>{props.scopeObjectPicker}</div>
