...
import { automationWorkspaceViewRegistrationEqual, selectAutomationWorkspaceViewRegistration } from "../workspace-view-registration";
...
import { useAutomationConnectedViewEntries, useAutomationConnectedViewSource, useAutomationConnectorCommands, type AutomationCanonicalConnectorScope } from "../view-host";
import { listProjectProblems } from "../../problems/problem-queries";
import { EMPTY_AUTOMATION_GATEWAY_SNAPSHOT, EMPTY_AUTOMATION_LIST, EMPTY_AUTOMATION_PROJECT_ARTIFACTS, EMPTY_AUTOMATION_RECORD } from "../session-project-view";
...
import { automationFlowEntryId, automationRecordingId, automationRunId, automationTimelineId, createAutomationSessionStoreCommands } from "../commands";
