...
| [module-size-governance-plan.md](./module-size-governance-plan.md) | Senior supervisor agent | 308 | Owns the shared size and structure policy for both repositories: the ratchet, the `tests/` relocation, the eight-phase migration of Automation Studio's oversized files and directories, and the CodeGraph assessment. | `module-size-governance-plan.md` |
