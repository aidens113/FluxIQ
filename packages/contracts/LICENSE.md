...
Except for third-party components that identify their own license, FluxIQ is
made available under the Sustainable Use License below.

Commercial licenses for uses outside these terms, including hosted, managed,
embedded, OEM, white-label, and redistribution rights, may be available under
a separate written agreement. See `COMMERCIAL-LICENSING.md` or contact
license@getfluxiq.com. Contacting the licensor does not grant any rights.

## Consulting Permission

In addition to the permissions below, a consultant or service provider may
charge for professional services that configure, integrate, support, or
maintain a customer's own FluxIQ installation solely for that customer's
internal business purposes. This permission does not allow the consultant or
service provider to host FluxIQ for customers, operate a shared or managed
FluxIQ service, provide FluxIQ functionality to third parties, redistribute
FluxIQ for a fee, or include FluxIQ in a product or service offered to third
parties.
