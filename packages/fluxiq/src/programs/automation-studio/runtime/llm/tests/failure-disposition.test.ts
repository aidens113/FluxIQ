...
describe("the provider failure disposition table", () => {
  ...
  // nineteen is ever a spent call.
  it("ends the grant on every one of the nineteen pre-send refusals", () => {
    expect(AUTOMATION_STUDIO_LLM_PROVIDER_PREFLIGHT_ERROR_CODES).toHaveLength(19);
