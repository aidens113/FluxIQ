...
import { AUTOMATION_STUDIO_PROJECT_ADAPTATION_EVIDENCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_ADAPTATION_MATCHING_MIGRATION, AUTOMATION_STUDIO_PROJECT_COMPILED_RUNTIME_ISOLATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_CONVERSATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_DOMAIN_RESOURCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_EVENT_CURSOR_MIGRATION, AUTOMATION_STUDIO_PROJECT_FAST_UI_QUERY_INDEX_MIGRATION, AUTOMATION_STUDIO_PROJECT_INTERVENTION_MODE_MIGRATION, AUTOMATION_STUDIO_PROJECT_MUTATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_RELATION_INDEX_MIGRATION, AUTOMATION_STUDIO_PROJECT_RETENTION_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_AUDIT_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_VALIDATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_RUNTIME_SCALING_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_RUNTIME_SUMMARY_DETAIL_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_TARGET_REFERENCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_RUNTIME_SUMMARY_ENVELOPE_MIGRATION, AUTOMATION_STUDIO_PROJECT_RUN_DATASET_MIGRATION, AUTOMATION_STUDIO_PROJECT_STREAM_SPOOL_MIGRATION } from "./schema.ts";
...
}, AUTOMATION_STUDIO_PROJECT_DOMAIN_RESOURCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_RELATION_INDEX_MIGRATION, AUTOMATION_STUDIO_PROJECT_MUTATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_STREAM_SPOOL_MIGRATION, AUTOMATION_STUDIO_PROJECT_EVENT_CURSOR_MIGRATION, AUTOMATION_STUDIO_PROJECT_RETENTION_MIGRATION, AUTOMATION_STUDIO_PROJECT_COMPILED_RUNTIME_ISOLATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_ADAPTATION_EVIDENCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_FAST_UI_QUERY_INDEX_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_RUNTIME_SCALING_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_RUNTIME_SUMMARY_DETAIL_MIGRATION, AUTOMATION_STUDIO_PROJECT_ROUTER_TARGET_REFERENCE_MIGRATION, AUTOMATION_STUDIO_PROJECT_INTERVENTION_MODE_MIGRATION, AUTOMATION_STUDIO_PROJECT_RUNTIME_SUMMARY_ENVELOPE_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_AUDIT_MIGRATION, AUTOMATION_STUDIO_PROJECT_REUSABLE_LLM_CONTEXT_VALIDATION_MIGRATION, AUTOMATION_STUDIO_PROJECT_RUN_DATASET_MIGRATION, AUTOMATION_STUDIO_PROJECT_ADAPTATION_MATCHING_MIGRATION, AUTOMATION_STUDIO_PROJECT_CONVERSATION_MIGRATION] as const;
